...
TouchScreenGestureInterface::State TouchScreenFourFingerSwipeGesture::handleInputEvent(libinput_event *event)
{
    ...
    case LIBINPUT_EVENT_TOUCH_FRAME: {
        ...
        // count offset
        auto last_center_points = (m_last_points[0] + m_last_points[1] + m_last_points[2] + m_last_points[3])/4;
...
{
    // count total offset
    auto start_center_points = (m_start_points[0] + m_start_points[1] + m_start_points[2] + m_start_points[3])/4;
